Pod::Spec.new do |s|
	...
	s.source           = { :git => 'https://github.com/SangWoo-So/LogiSocket.git', :tag => s.version.to_s }
	#s.source       = { :path => "." }
	...
	s.subspec 'Base' do |ll|
	  #ll.private_header_files = 'LogisoftLibrary/Distribution/**/*.{h}'
	  ll.vendored_libraries = 'LogisoftLibrary/Distribution/libLogisoftLibrary.a'
	  ll.source_files = 'LogisoftLibrary/Distribution/**/*.{h,m,mm}', 'LogisoftLibrary/Distribution/libLogisoftLibrary.a'
  
	  ll.pod_target_xcconfig = {
